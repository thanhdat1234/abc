...
<div class="row">
	<div class="col-sm-12">
		<form action="<?php echo base_url('admin/news/add');?>" id="frm_news_New" class="form-horizontal"   method="post"  enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                   <select name="category" id="" class="form-control">
                       <option value="0">Xu hướng thời trang</option>
            ...
            <div class="form-group <?php if(form_error('avarta') != NULL){echo 'has-error';}?>">
                ...
                <div class="col-sm-10">
                    <input name="avarta" class="form-control" placeholder="Link ảnh đại diện" value="<?php echo set_value('avarta');?>" id="keyword" type="text">
