...
<div class="row">
    <div class="col-sm-12">
        <form action="<?php echo base_url('admin/news/edit/'.$result['id'].'');?>" id="frm_news_New" class="form-horizontal"   method="post"  enctype="multipart/form-data">
            <div class="form-group <?php if(form_error('title') != NULL){echo 'has-error';}else if(!empty($error_news)){echo 'has-error';}?>">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Nhập tên sản phẩm" name="title" value = "<?php if($result['title'] != NULL){ echo $result['title'];}else{echo set_value('title');}?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                   <select name="category" id="" class="form-control">
                       <option value="0" <?php if($result['category'] == 0){echo 'selected=""';}?> > Xu hướng thời trang</option>
                       <option value="1" <?php if($result['category'] == 1){echo 'selected=""';}?> > Khuyến mại</option>
                   </select>
                </div>
            </div>
            ...
            <div class="form-group col-sm-12 action">
                ...
                <div class="col-sm-10">
                   <div >
                       <img id="defin_files" src="<?php echo SITE_URL.$result['images'];?>" width="100" height="100" alt="">
                   </div>
                </div>
            </div>
            ...
            <div class="form-group <?php if(form_error('avarta') != NULL){echo 'has-error';}?>">
                ...
                <div class="col-sm-10">
                    <input name="avarta" class="form-control" placeholder="Link ảnh đại diện" value="<?php if($result['avarta'] != NULL){ echo $result['avarta'];}else{echo set_value('avarta');}?>" id="keyword" type="text">
...
<script>
    ...
    function back_to_list(){
        $(".content").mask("<?php echo 'Loading...'; ?>");
        $(".content").load('<?php echo base_url("admin/news/list_all");?>',function(){
            $('.content input[type="checkbox"]').iCheck({checkboxClass: 'icheckbox_minimal'});
            $('.content input[type="radio"]').iCheck({radioClass: 'iradio_minimal'}); 
        });
    }
    ...
    $("#fileuploader").uploadFile({
        ...
        deleteCallback: function (data) {
            ...
            setTimeout(function () {
                $.ajax({
                        url : '<?php SITE_URL?>/admin/news/deleteImage',
                        type: "POST",
                        data : {url:data},
                        cache: true,
