        ...
        <div class="page-content">
            <table class="table table-bordered table-compare">
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="<?php echo base_url('assets/home')?>/data/p40.jpg" alt="Product"></a>
                    </td>
                    <td>
                        <a href="#"><img src="<?php echo base_url('assets/home')?>/data/p42.jpg" alt="Product"></a>
                    </td>
                    <td>
                        <a href="#"><img src="<?php echo base_url('assets/home')?>/data/p41.jpg" alt="Product"></a>
                    </td>
